...
<template>
  <Teleport to="body">
    <Transition name="fade">
      <div
        v-if="visible"
        class="fixed z-[50] top-0 left-0 w-full h-full flex justify-center items-center p-4 overflow-hidden flex flex-col">
        <div class="absolute bg-black bg-opacity-50 w-full h-full"></div>
        <div class="relative min-w-[200px] min-h-[120px] bg-bg rounded">
